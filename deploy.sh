...
docker tag keboola/orchestrator-cli:latest 061240556736.dkr.ecr.us-east-1.amazonaws.com/keboola/orchestrator-cli:$TRAVIS_COMMIT
docker tag keboola/orchestrator-cli:latest 061240556736.dkr.ecr.us-east-1.amazonaws.com/keboola/orchestrator-cli:latest
docker push 061240556736.dkr.ecr.us-east-1.amazonaws.com/keboola/orchestrator-cli:$TRAVIS_COMMIT
